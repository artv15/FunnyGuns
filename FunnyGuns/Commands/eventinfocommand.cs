        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
        {
            if (Plugin.isRunning)
            {
                response = "\n<color=green>Funny Guns</color>\n<color=red>--Ваша задача--</color>\n<color=blue>Вы должны выжить и уничтожить команду соперника</color>\n<color=red>--Стадии--</color>\n" +
                    ...
                    " пока можешь!\n\nCredits:\n-<Developer (plz give me fud): Treeshold#0001 (aka Star Buttefly)>-\nBeta tester: Dlorka#9909 (aka Tushkanchik)\nAnd some people from Bread Adventures.\n\n<color=green>Thanks guys, this was a fun ride!</color>";
                return true;
            }
            else
            {
